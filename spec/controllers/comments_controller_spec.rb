  ...
  describe "POST #create" do
    ...
    context "with valid params" do
      it "creates a new Comment" do
        expect {
          post :create, params: {comment: valid_attributes, :"#{valid_attributes['belongs_to_type'].downcase}_id" => valid_attributes['belongs_to_id']}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {comment: invalid_attributes, :"#{valid_attributes['belongs_to_type'].downcase}_id" => invalid_attributes['belongs_to_id']}, session: valid_session
        expect(response).to be_success
      end
    end
  end
